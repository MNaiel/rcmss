...
%
% Caltech Pedestrian Dataset     Version 3.0.1
...
for i = 1
  ...
  switch dn
    case {'UsaTest'}
      aIds=[1:15 6.1 6.2 16];
    case {'Usa','UsaTrain'}
      aIds=[1:14 6.1 6.2 16];
    case 'Japan'
      aIds=[1:13 6.1 6.2 16];
    case 'InriaTest'
      aIds=[1:13 6.1 14.4 16]; bnds=[];
    case 'TudBrussels'
      aIds=[1:2 4:13 6.1 6.2 16]; bnds=[];
    case 'ETH'
      aIds=[1:2 4:13 6.1 6.2 16]; bnds=[];
    case 'Daimler'
...
for id=ids
  switch id
    ...
    case 15,    alg=def('MultiResC',0,id);
    case 16,    alg=def('Crosstalk',0,id);
