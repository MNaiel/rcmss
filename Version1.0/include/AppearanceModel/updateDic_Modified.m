function [X_neg alpha_qq] = updateDic_Modified(dataPath, sz, opt, param, num_n, forMat, p0, f, alpha_q, alpha_p, occMap)
...
if size(img_color,3)==3, img	= double(rgb2gray(img_color));else    img	= double(img_color);end;
...
X_neg= ConcatenateWarpImage(wimgsColor,opt,n);
