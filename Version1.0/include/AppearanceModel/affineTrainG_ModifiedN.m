function [X_pos X_neg wimgsPos wimgsNeg] = affineTrainG_ModifiedN(img_color, sz, opt, param, num_p, num_n, forMat, p0,SigmaAffineNegSamples,SaveWaripImages,SaveDirectory, ID)
...
%% All rights reserved.
%% Date: 05/2012
%% Modified by Naiel in Nov. 2014
Show=0;
if (nargin <10)
    SaveWaripImages=0;    
end
img=PerFrameFunction(img_color,opt);
%%----------------- positive templates----------------%%
...
[wimgs wimgsColor o BadExample]=warpimgFunction(img, o, sz,opt);
n=size(o,2);
...
o = affparam2mat(param.param);    %Extract or Warp Samples which are related to above affine parameters
[wimgs wimgsColor o]= warpimgFunction(img, o, sz,opt);
